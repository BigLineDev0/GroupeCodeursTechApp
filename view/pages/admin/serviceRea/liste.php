		...
		<div id="content" class="content">
			<ol class="breadcrumb float-xl-right">
				<li class="breadcrumb-item">
					<a href="#modal-add-service-rea" class="btn btn-sm btn-dark text-white" data-toggle="modal">Ajouter</a>
				</li>
							...
							<?php if(!empty($listeServiceReas)) : ?>
								<?php foreach($listeServiceReas as $serviceRea) : ?>
									<tr class="odd gradeX">
										...
										<td class="text-center">
											<!-- Edit -->
											<a href="serviceReaMainController?id=<?= htmlspecialchars($serviceRea['id'])?>&action=edit"
												class="btn-edit"
