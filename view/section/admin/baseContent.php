<div id="content" class="content">
    ...
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item"><a href="listeServiceRea">Services / Réalisations</a></li>
        <li class="breadcrumb-item"><a href="listeUser">Utilisateurs</a></li>
        <li class="breadcrumb-item"><a href="listeNewsletter">Newsletter</a></li>
        <li class="breadcrumb-item"><a href="listeContact">Contact</a></li>
    </ol>
   
    <h1 class="page-header mb-3">Tableau de bord Administration</h1>
    <!-- end page-header -->
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-5 col-lg-4 align-items-center d-flex justify-content-center">
                            <img src="public/template/templateAdmin/assets/img/svg/img-1.svg" height="150px" class="d-none d-lg-block" />
                        </div>
                        <!-- end col-5 -->
                    </div>
                    <!-- end row -->
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="d-flex align-items-center text-white mb-2">
                            <div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(public/template/templateAdmin/assets/img/flag/us.jpg)"></div>
                        ...
                        <div class="d-flex align-items-center text-white mb-2">
                            <div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(public/template/templateAdmin/assets/img/flag/cn.jpg)"></div>
                            <div class="d-flex w-100">
                                <div>China</div>
                        ...
                        <div class="d-flex align-items-center text-white mb-2">
                            <div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(public/template/templateAdmin/assets/img/flag/de.jpg)"></div>
                            <div class="d-flex w-100">
                                <div>Germany</div>
                        ...
                        <div class="d-flex align-items-center text-white mb-2">
                            <div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(public/template/templateAdmin/assets/img/flag/fr.jpg)"></div>
                            <div class="d-flex w-100">
                                <div>France</div>
                        ...
                        <div class="d-flex align-items-center text-white mb-0">
                            <div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(public/template/templateAdmin/assets/img/flag/jp.jpg)"></div>
                            <div class="d-flex w-100">
                                <div>Japan</div>
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-6">
            ...
            <div class="card border-0 mb-3 bg-dark-darker text-white">
                <!-- begin card-body -->
                <div class="card-body" style="background: no-repeat bottom right; background-image: url(public/template/templateAdmin/assets/img/svg/img-4.svg); background-size: auto 60%;">
                    <!-- begin title -->
                    <div class="mb-3 text-grey">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center m-b-15">
                        <div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
                            <div class="h-100 w-100" style="background: url(public/template/templateAdmin/assets/img/product/product-8.jpg) center no-repeat; background-size: auto 100%;"></div>
                        </div>
                    ...
                    <div class="d-flex align-items-center m-b-15">
                        <div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
                            <div class="h-100 w-100" style="background: url(public/template/templateAdmin/assets/img/product/product-9.jpg) center no-repeat; background-size: auto 100%;"></div>
                        </div>
                        <div class="text-truncate">
                    ...
                    <div class="d-flex align-items-center m-b-15">
                        <div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
                            <div class="h-100 w-100" style="background: url(public/template/templateAdmin/assets/img/product/product-10.jpg) center no-repeat; background-size: auto 100%;"></div>
                        </div>
                        <div class="text-truncate">
                    ...
                    <div class="d-flex align-items-center m-b-15">
                        <div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
                            <div class="h-100 w-100" style="background: url(public/template/templateAdmin/assets/img/product/product-11.jpg) center no-repeat; background-size: auto 100%;"></div>
                        </div>
                        <div class="text-truncate">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
                            <div class="h-100 w-100" style="background: url(public/template/templateAdmin/assets/img/product/product-12.jpg) center no-repeat; background-size: auto 100%;"></div>
                        </div>
                        <div class="text-truncate">
            ...
            <div class="card border-0 mb-3 bg-dark text-white">
                ...
                <div class="card-body">
                    ...
                    <div class="row align-items-center p-b-1">
                        ...
                        <div class="col-4">
                            <div class="height-100 d-flex align-items-center justify-content-center">
                                <img src="public/template/templateAdmin/assets/img/svg/img-2.svg" class="mw-100 mh-100" />
                            </div>
                        </div>
                        <!-- end col-4 -->
                        <!-- begin col-8 -->
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-4">
                            <div class="height-100 d-flex align-items-center justify-content-center">
                                <img src="public/template/templateAdmin/assets/img/svg/img-3.svg" class="mw-100 mh-100" />
                            </div>
                        </div>
                        <!-- end col-4 -->
                        <!-- begin col-8 -->
