...
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <div class="team">
            <div class="image" data-animation="true" data-animation-type="flipInX">
                <img src="public/template/templateVitrine/assets/img/user/user-1.jpg" alt="Ryan Teller" />
            </div>
            <div class="info">
    ...
    <div class="col-lg-4">
        ...
        <div class="team">
            <div class="image" data-animation="true" data-animation-type="flipInX">
                <img src="public/template/templateVitrine/assets/img/user/user-2.jpg" alt="Jonny Cash" />
            </div>
            <div class="info">
    ...
    <div class="col-lg-4">
        ...
        <div class="team">
            <div class="image" data-animation="true" data-animation-type="flipInX">
                <img src="public/template/templateVitrine/assets/img/user/user-3.jpg" alt="Mia Donovan" />
            </div>
            <div class="info">
